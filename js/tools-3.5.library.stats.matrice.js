tools.Library.Stats = {
    ...
    Matrice: function () {
        ...
        // Iterator
        this.nextIndexRow = function () {
            if (this.currentIndexRow > (this.getColonnes().length - 1)) {
                this.currentIndexRow = 0
            }
            return this.currentIndexRow++;
        }

        this.nextIndexCol = function () {
            if (this.currentIndexCol > (this.getLignes().length - 1)) {
                this.currentIndexCol = 0
            }
            return this.currentIndexCol++;
        }

        this.nextElement = function () {
            let
                currentIndexRow = this.nextIndexRow(),
                currentIndexCol = this.nextIndexCol();

            return {
                indexRow: currentIndexRow,
                indexCol: currentIndexCol,
                val: this.getElementIndex(currentIndexCol, currentIndexRow)
            };
        }
